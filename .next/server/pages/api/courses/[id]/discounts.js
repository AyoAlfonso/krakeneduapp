...
module.exports = __webpack_require__("iNJN");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateDiscountValidator", function() { return CreateDiscountValidator; });
...
async function getDiscounts(req) {
  ...
  let [maintainer, discounts] = await Promise.all([lib_prisma__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].course_maintainers.findUnique({
    where: {
      course_maintainer: {
        course: courseID,
        maintainer: user.id
  ...
  }), lib_prisma__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].course_discounts.findMany({
    where: {
      course: courseID,
      deleted: false
    }
...
const CreateDiscountValidator = runtypes__WEBPACK_IMPORTED_MODULE_1__["Record"]({
  amount: runtypes__WEBPACK_IMPORTED_MODULE_1__["Number"],
  name: runtypes__WEBPACK_IMPORTED_MODULE_1__["String"],
  type: runtypes__WEBPACK_IMPORTED_MODULE_1__["Union"](runtypes__WEBPACK_IMPORTED_MODULE_1__["Literal"]('percentage'), runtypes__WEBPACK_IMPORTED_MODULE_1__["Literal"]('absolute')),
  max_redeems: runtypes__WEBPACK_IMPORTED_MODULE_1__["Number"].Or(runtypes__WEBPACK_IMPORTED_MODULE_1__["Undefined"])
});
...
async function createDiscount(req) {
  ...
  let maintainer = await lib_prisma__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].course_maintainers.findUnique({
    where: {
      course_maintainer: {
        course: courseID,
        maintainer: user.id
  ...
  let discount = await lib_prisma__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].course_discounts.create({
    data: {
      courses: {
        connect: {
          id: courseID
      ...
      name: msg.name,
      type: msg.type,
      code: Object(uuid__WEBPACK_IMPORTED_MODULE_3__["v4"])(),
      amount: msg.amount,
