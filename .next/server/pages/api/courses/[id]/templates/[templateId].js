...
module.exports = __webpack_require__("dfDT");
...
async function deleteTemplate(req) {
  ...
  let course_maintainer = await lib_prisma__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].course_maintainers.findUnique({
    where: {
      course_maintainer: {
        course: courseId,
        maintainer: user.id
  ...
  try {
    await lib_prisma__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].course_templates.delete({
      where: {
        name_course: {
          name: templateId,
          course: courseId
...
async function updateTemplate(req) {
  ...
  let template = await lib_prisma__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].course_templates.findUnique({
    where: {
      name_course: {
        name: templateId,
        course: courseId
  ...
  let updatedTemplate = await lib_prisma__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].course_templates.update({
    where: {
      name_course: {
        name: templateId,
        course: courseId
...
/******/ });
//# sourceMappingURL=[templateId].js.map