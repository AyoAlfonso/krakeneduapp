...
The KrakenEdu community is powered by Discourse — modern, open source, highly flexible forum software. If you're new to Discourse, this is a great post covering the basics: [Discourse New User Guide](https://meta.discourse.org/t/discourse-new-user-guide/96331).

## Video Calls

Since KrakenEdu courses happen online and we can't all be in the same room, the next best thing is video calls — for group workshops, office hours, presentations, or anything else that calls for a live session.
...
All your cohort events (for all your courses / clubs) will sync to your personal KrakenEdu Calendar, which you can [subscribe to here](/calendar).

We recommend the following software:

- **Zoom:** popular and performant. Pros: widely used; works well even for large groups. Cons: requires a paid account for group calls > 40 minutes. We suggest using your own Zoom account if you have one, or get in touch with us to use a KrakenEdu Zoom account.
...
As noted, KrakenEdu courses should be *active* — focused on collaboration and feedback with other learners. There are many tools that facilitate this sort of collaboration online, and you should use whichever fit the needs of your course.
...
The KrakenEdu platform itself is open source software. You can [view the source code](https://gitlab.com/jaredpereira/hyperlink-academy) and submit changes if you find a bug! 
