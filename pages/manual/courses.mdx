...
3. We'll review, and if it seems like a good fit, see if you'd like to join the [Meta Course](/courses/the-meta-course/1) — a special invite only course we run regularly to workshop courses and get them ready to go live on Krakenedu..
4. In each cohort of the Meta Course, a small group of prospective course creators meets with KrakenEdu staff over five weekly calls. You'll share your course proposal, give and receive feedback, and develop your curriculum.
5. Once you complete the Meta Course:
    ...
    - **If you don't feel ready:** Don't worry, take all the time you need! You can even retake the Meta Course if you like. Just [email to let us know](mailto:contact@krakenedu.com) if / when you want to launch.
6. Once your course is made, it will have a page on Krakenedu, as well as a private forum for general discussion about the course (in addition to a forum space for each cohort). Next steps:
...
- **Cost:** How much does a learner pay to participate in a cohort? Krakenedu's platform fee is 20% of the course cost; the remaining 80% goes straight to compensating the facilitator.
...
We believe there's a huge possibility space for what learning can look like. KrakenEdu can't explore *all* of it, so we encourage courses aligned with our core Principles.

Great KrakenEdu courses:
