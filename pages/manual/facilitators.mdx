...
Facilitators lead cohorts of KrakenEdu courses and clubs. They are participants, but are also guides, responsible for shaping the learning environment. If a course is a score and a cohort is a performance, the facilitator is the conductor.
...
- **You will be compensated:** Facilitators should be paid fairly for their efforts. KrakenEdu takes 20% of tuition (same for courses and clubs), including payment processing fees. The other 80% goes straight to the facilitator.
...
1. If you're interested in facilitating an existing course, reach out to the course maintainer by direct message on the forum ([email us](mailto:contact@krakenedu.com) if you're not sure who to talk to). Be sure to mention:
...
3. There are a couple details we'll need to take care of in order to pay you properly. Keep an eye out for an email with info on the following:
    ...
    - KrakenEdu is technically hiring you as a contractor when you become a facilitator, so you'll also need to fill out a 1099 for tax purposes.
...
2. **During the cohort**
    ...
    - Lean on the KrakenEdu community for support! As a facilitator you'll have access to the Meta Course forum, where we can talk through any questions or issues regarding maintenance and facilitation.
3. **After the cohort**
    - Gather feedback and surface learning output, as a resource for the course. Two final discussion topics to make—
        - **Artifacts:** Every course on KrakenEdu should result in learners producing some sort of artifact, whether an essay, final project, or research plan. Once the cohort is over, create a topic in the public course forum highlighting the artifact(s) that were produced.
