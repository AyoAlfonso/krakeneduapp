...
//Note to Self : eventually i should add the Krakenedu profile link and the twitter profile link and two separate small links under the name. 
type TeamProfile = {
    profileImg:string,
    name:string,
    username:string,
...
My interests: weird synthesizers, sci-fi and fantasy worlds, free software and information theory.`,
        ...
        h(TeamProfile, {
          ...
          username: "celine",
          bio: `
Before KrakenEdu I was a Product Designer. In my free time I enjoy making clothes, making pots and dishes, making tables, making paper sculptures, and making other stuff. Despite what this sounds like I also enjoy buying things. 
...
My interests: havin' a good time over a diet coke and some cake. And of course: lorem ipsum dolor sit amet.`,
        ...
        h(TeamProfile, {
          ...
          title: "Co-Founder",
          bio: `
I like to make things, in many media: photography to film, hip-hop lyrics to websites. Before Krakenedu, I helped build a learning platform for guitarists. I also run [Antilibraries](https://www.antilibrari.es), a book curation site and bibliophile community.
