...
const Dashboard = () => {
  ...
  let upcomingEvents = enrolledThings.events.filter(
    (e) => e.events.end_date > new Date().toISOString()
  );
  ...
  return h(Box, { gap: 64 }, [
    ...
    profile.classroom_onboarding
      ...
      : h(Box, { gap: 32, width: 640, style: { textAlign: "center" } }, [
          h("h2", "You need to join the classroom to complete your signup!"),
          h(Box, [
            h(
              "b",
            ...
            h(
              ...
              {
                style: { margin: "auto" },
                href: `${DISCOURSE_URL}/session/sso?return_path=/`,
                target: "_blank",
              },
