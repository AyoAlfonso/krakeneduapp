...
In the past our Meta Course curriculum was very straightforward. In our first session we mentioned KrakenEdu, our values, and our origin story. We then did introductions and talked about the courses we wanted to run. Then we tasked everyone to take a stab at writing a curriculum for homework. The following two sessions were 1.5 hour long group feedback sessions. We looked at every person's curriculum in turn and thought about how to improve or solve problems. The homework was to expand and polish the curriculum. You can read a review we did of of those [here](https://app.krakenedu.com/library/learning-from-the-meta-course).

### The New

This time around, we expanded the Meta Course to 5 weeks. Each week included some time giving feedback in smaller breakout groups, and some time focused on a specific aspect of curriculum making (KrakenEdu courses, course structure, exercise design, facilitation). Homework was sometimes a specific assignment, but usually to develop the course more.
...
I thought a strength of the new Meta Course format was focusing on an aspect of course creation every week. We ended up focusing on KrakenEdu's course philosophy, course structure, exercise and assignment design, and facilitation. Having these topics helped frame, organize, and diversify our conversations.
...
_Lucy (Twitter: [@LuBellWoo](https://twitter.com/LuBellWoo))_
...
_Stephen (Twitter: [@stephencreates](https://twitter.com/stephencreates))_
...
_Shreeda (Twitter: [@freeshreeda](https://twitter.com/freeshreeda))_

### [Neostalgic Computing](https://app.krakenedu.com/courses/neostalgic-computing/63)
...
_Jackie (Twitter: [@jackieis_online](https://twitter.com/jackieis_online))_

### Experimental Divination

On inventing our own systems of divination, spell casting, and fortune telling.

_Danielle (Twitter: [@djbaskin](https://twitter.com/djbaskin))_

### [The Home Collection](https://app.krakenedu.com/courses/the-home-collection-game/64)
...
_Angelica (Website: [https://aiconservation.weebly.com/](https://aiconservation.weebly.com/))_

### Lustrous Points

On the art of photogrammetry, and the implications of this technology on our perceptions of 2D and 3D

_Philo (Twitter: [@phivk](https://twitter.com/phivk))_
