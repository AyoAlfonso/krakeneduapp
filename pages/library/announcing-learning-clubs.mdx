...
KrakenEdu is built to support the sort of courses we want to see more of — small cohorts of learners, guided by a curriculum and facilitator, exploring a specific topic together.
...
Here are some ideas for Clubs we think could be amazing on Krakenedu:
...
### [KrakenEdu - Request for Learning Clubs](https://app.krakenedu.com/forms/propose-club)
