...
# topic: "https://classroom.krakenedu.com/t/what-can-courses-be/389"
---
...
First, we've identified some common qualities of courses we think work well on Krakenedu:
...
These are just high-level qualities, things we believe make for good learning experiences, and differentiate the sort of learning that happens on KrakenEdu from other learning resources like MOOCs and YouTube videos.
...
- Sal's course, [Infinite Art](https://app.krakenedu.com/courses/infinite-art/58)
- David's course, [Write a Micro-Textbook](https://app.krakenedu.com/courses/write-a-micro-textbook/14)
- Jackie's course, [Neostalgic Computing](https://app.krakenedu.com/courses/neostalgic-computing/63)
...
- Elizabeth's course, [GUIs Through Art History](https://app.krakenedu.com/courses/guis-through-art-history/2)
- Jinjin's course, [Anti-Perfectionist Drawing](https://app.krakenedu.com/courses/anti-perfectionism-drawing/7)
...
- Daniel's course, [Esoteric Programming Language Theory](https://app.krakenedu.com/courses/esoteric-programming-language-theory/48)
- Lluvia's course, [Whose Land Is This Anyway?](https://app.krakenedu.com/courses/whose-land-is-this-anyway/51)
...
- Colin's course, [Language Construction Workshop](https://app.krakenedu.com/courses/language-construction-workshop/26)
- Rebecca's course, [Building Online Communities](https://app.krakenedu.com/courses/building-online-communities/25)
- Calvin's course, [Designing Neighborhood Scale Software](https://app.krakenedu.com/courses/design-neighborhood-scale-software/50)
...
- Pamela's course, [Stop Thinking In Circles](https://app.krakenedu.com/courses/stop-thinking-in-circles/32)
- Adolfo's course, [Antifragile Writing with Roam Research](https://app.krakenedu.com/courses/antifragile-writing-with-roam-research/49)
...
For more on this topic, see our guide [How to Think About Course Pricing](https://app.krakenedu.com/library/how-to-think-about-course-pricing).
...
Here are a few practical steps and exercises we've found helpful in beginning to think through the above. This draws from our experience running the Meta Course and seeing over two dozen courses and clubs launch on Krakenedu.
...
If you've enjoyed this piece, we think you'll love the [Meta Course](https://app.krakenedu.com/courses/the-meta-course/1) — all about taking the above, applying to a specific course idea, and workshopping together to iteratively refine the shape of that course into something you can teach!

If you've read this far and have an idea for a course on Krakenedu, go ahead and [propose a course here](https://app.krakenedu.com/forms/propose-course).

We focus here on courses, but many of the same considerations apply to clubs — often similarly structured but more experimental and emergent. You can [propose a club here](https://app.krakenedu.com/forms/propose-club).

## Relevant Readings

These may be helpful / inspirational as you start to put together your own course outline and curriculum. Note that many of the courses below are a bit longer than most on Krakenedu, but still great references!
