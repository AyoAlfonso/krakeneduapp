...
Krakenedu's latest batch of learning is here! An awesome array of courses, clubs, and events…AKA a **knowledge drop**, if you will.

We're moving to monthly launches — so you can expect another update at the same time next month.

First, a number of new course and club cohorts now open for enrollment, starting later Feb and early March. Click each to learn more, view schedules, and enroll. You can also view all here: [Courses](https://app.krakenedu.com/courses) + [Clubs](https://app.krakenedu.com/clubs).

## Courses

### [Whose Land Is This Anyway?](https://app.krakenedu.com/courses/whose-land-is-this-anyway/51)
...
### [Internet Homesteading](https://app.krakenedu.com/courses/internet-homesteading/22)

Build yourself a home on the internet (a website) with a toolchain you understand from the ground up.

Starts Feb 15, $150

### [Language Construction Workshop](https://app.krakenedu.com/courses/language-construction-workshop/26)
...
### [Antifragile Writing with Roam Research](https://app.krakenedu.com/courses/antifragile-writing-with-roam-research/49)
...
### [Anti-Burnout Artists Spa](https://app.krakenedu.com/courses/anti-burnout-artists-spa/79)
...
### [Framing Complex Ideas](https://app.krakenedu.com/courses/framing-complex-ideas/74)
...
### [Virtual Museum Explorer Club](https://app.krakenedu.com/courses/virtual-museum-explorer-club/38)

We'll go on tours via scavenger hunt through the virtual collections of world-class art museums.

Starts March 1, $35

### [Comics Making for the Rest of Us](https://app.krakenedu.com/courses/comics-making-for-the-rest-of-us/61)
...
New on KrakenEdu — one-off learning events! We now support events both free and paid; standalone experiments and events related to existing courses/clubs. See upcoming events below, and view all here: [Events](https://app.krakenedu.com/events).
...
### [Conlang With Me #1](https://app.krakenedu.com/events/214)
...
### [Antilibrary Book Show and Tell](https://app.krakenedu.com/events/282)
...
### [Stream of Consciousness Comics Workshop](https://app.krakenedu.com/events/228)
...
### [Intro to Experiential Learning with Jake Fee](https://app.krakenedu.com/events/281)
...
### [Crochet Foundations](https://app.krakenedu.com/events/248)
...
We've got two more cohorts of the Meta Course starting this month — and we're trying something new, with themed cohorts, anticipating our development of KrakenEdu __Departments__.
...
As always, you can submit ideas for courses (to develop in the Meta Course) and clubs (to try any time) here: [courses](https://app.krakenedu.com/forms/propose-course) + [clubs](https://app.krakenedu.com/forms/propose-club).
