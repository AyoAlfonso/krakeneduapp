...
Here at KrakenEdu we're packing bags, buying provisions, setting up base camp — getting ready for an experimental expedition:
...
We're experimenting with [Learning Adventures](https://app.krakenedu.com/courses/hyperlink-learning-adventure-club/76) as a peer-driven learning club on Hyperlink.
...
Our first cohort starts **Monday, Feb 1**. To join, [propose an adventure](https://app.krakenedu.com/forms/propose-adventure) by **Wednesday, Jan 27**. Details below.
...
**If you turn your project into a KrakenEdu course or club in the next six months, we'll refund the cost of this adventure cohort.**
...
- [Brendan](https://app.krakenedu.com/people/brendan) will facilitate this beta cohort, starting **February 1**
...
[Propose an adventure here](https://app.krakenedu.com/forms/propose-adventure)
...
- You can view the cohort details and full schedule here: [Learning Adventure Cohort 1](https://app.krakenedu.com/courses/hyperlink-learning-adventure-club/76/cohorts/65)

Please [let us know](mailto:contact@krakenedu.com) if you have any questions, or ideas for things we should try in this cohort! This is very much an experiment and we plan to iterate and improve as we go; we'd love to hear suggestions.
