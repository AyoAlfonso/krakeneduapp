...
We're experimenting with [Learning Adventures](https://krakenedu.com/courses/hyperlink-learning-adventure-club/76) as a peer-driven learning club on Hyperlink.
...
Our first cohort starts **Monday, Feb 1**. To join, [propose an adventure](https://krakenedu.com/forms/propose-adventure) by **Wednesday, Jan 27**. Details below.
...
- [Brendan](https://krakenedu.com/people/brendan) will facilitate this beta cohort, starting **February 1**
...
[Propose an adventure here](https://krakenedu.com/forms/propose-adventure)
...
- You can view the cohort details and full schedule here: [Learning Adventure Cohort 1](https://krakenedu.com/courses/hyperlink-learning-adventure-club/76/cohorts/65)
