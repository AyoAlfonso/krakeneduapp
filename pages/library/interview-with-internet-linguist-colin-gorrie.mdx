...
Today we chat with linguist Colin Gorrie, who facilitates both [Language Construction Workshop](https://krakenedu.com/courses/language-construction-workshop/26) and [Meta-Skills for Learning Languages](https://krakenedu.com/courses/meta-skills-for-language-learning/70). We chat about the happy coincidence that the best way to learn new languages is also the most enjoyable way, the present and the future of PhDs who love to teach, and get into some fun language tangents along the way!

[Meta-Skills for Learning Languages](https://krakenedu.com/courses/meta-skills-for-language-learning/70) has a cohort starting January 16th. It meets every Saturday so if you like what you hear, get more by enrolling in that! You can also follow Colin on his twitter ([@colingorrie](https://twitter.com/colingorrie)) or his digital garden (colingorrie.com)
