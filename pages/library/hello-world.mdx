...
topic: "https://forum.krakenedu.com/t/hello-world/387"
---
...
KrakenEdu is all about *hyper-effective* learning experiences. Our mission is not just "pretty good" learning or "bit better than a video" learning. It is: "wow they sweated the details" learning. "I wish all learning was like that" learning. "This is what the internet was made for" learning.
...
Each course on KrakenEdu is a structured curriculum for a learning experience. Courses are run in independent ***cohorts*** — groups following the curriculum on a set schedule, led by a facilitator, learning together. With each cohort, the course itself learns and improves.
...
Interested in exploring unconventional learning? Have a *niche* to scratch? Create a course on Krakenedu, and we'll help you experiment with building an amazing learning experience!
