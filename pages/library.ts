...
export const collections = {
  ...
  startups: {
    title: "Startups",
    description: "Essays on startups and business",
  },
  interviews: {
    title: "Interviews",
  ...
  skills: {
    title: "Skills",
    description:
      "Essays on human development, craftsmanship, skill aquisition, transfer and mentorship",
  },
  founders: {
    title: "Founders",
    description: "Essays on founding companies, starting ideas and ending them",
  },
  hiring: {
    title: "Hiring",
    description: "Essays on hiring and human capital pipelines",
  },
};
    ...
    ...Object.keys(collections)
      .flatMap((slug) => {
        ...
        let posts = props.posts
          .filter((p) => p.tags && p?.tags?.includes(slug))
          .sort((a, b) => {
